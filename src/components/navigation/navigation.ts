...
import { heroicons, navigationIconMap } from '../../client/shared/config/heroicons';
  ...
  <div class="nav-container">
    <div class="nav-tabs">
      <button class="${cls('get-started')}" data-section="get-started">
        <span class="nav-icon">${heroicons[navigationIconMap['get-started']]}</span>
        <span class="nav-text">${UI_TEXTS.NAVIGATION.GET_STARTED}</span>
      </button>
      <button class="${cls('best-practices')}" data-section="best-practices">
        <span class="nav-icon">${heroicons[navigationIconMap['best-practices']]}</span>
      ...
      <button class="${cls('how-to-implement')}" data-section="how-to-implement">
        <span class="nav-icon">${heroicons[navigationIconMap['how-to-implement']]}</span>
      ...
      <button class="${cls('how-to-apply-cc')}" data-section="how-to-apply-cc">
        <span class="nav-icon">${heroicons[navigationIconMap['how-to-apply-cc']]}</span>
      ...
      <button class="nav-tab" onclick="window.location.href='/trends/20251007'">
        <span class="nav-icon">${heroicons[navigationIconMap['ai-trends']]}</span>
