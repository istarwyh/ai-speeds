/**
 * Heroicons SVG 图标库
 * 使用 Tailwind 官方 Heroicons 的 outline 风格
 * https://heroicons.com/
 */
...
// 分类图标映射
export const categoryIconMap: Record<string, keyof typeof heroicons> = {
  // Best Practices
  workflow: 'arrowPath',
  configuration: 'cog',
  'mcp-commands': 'wrench',
