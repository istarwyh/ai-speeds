...
export type SectionId = 'get-started' | 'best-practices' | 'how-to-implement' | 'how-to-apply-cc';

export const SECTION_IDS: SectionId[] = ['get-started', 'best-practices', 'how-to-implement', 'how-to-apply-cc'];
